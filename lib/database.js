...
const databaseUrl = Helper.opts['db'] || 'mongodb+srv://arase321:arase33512@arase.qcqq5y3.mongodb.net/?retryWrites=true&w=majority'
const databaseAdapter = /https?:\/\//.test(databaseUrl) ?
	new cloudDBAdapter(databaseUrl) : /mongodb(\+srv)?:\/\//i.test(databaseUrl) ?
		(Helper.opts['mongodbv2'] ? new mongoDBV2(databaseUrl) : new mongoDB(databaseUrl)) :
			new JSONFile(`${Helper.opts._[0] ? Helper.opts._[0] + '_' : ''}mongodb+srv://arase321:arase33512@arase.qcqq5y3.mongodb.net/?retryWrites=true&w=majority`)
